...
/** Compact toast for background SMB upload done / fail (Phase 37.1). */
export function BackgroundUploadToastCard({
  visible,
  ok,
  title,
  message,
    ...
    <div
      ...
      className={cn(
        ...
        ok
          ...
          : "border-destructive/30 bg-[color-mix(in_srgb,var(--ats-card)_88%,var(--ats-destructive)_12%)]",
      )}
    >
      <div
        className={cn(
