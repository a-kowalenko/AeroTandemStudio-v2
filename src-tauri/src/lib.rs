...
use commands::app::{
    ...
    probe_clear_local_job_folders, run_auto_cleanup, run_startup_checks, set_log_min_level,
};
use commands::bridge::{
...
use commands::media::{
    clear_photo_edit_undo, clear_working_session, copy_files_to_directory, crop_photo,
    delete_working_copies, delete_working_copy, discard_photo_edit_undo_for_path,
    expand_media_paths, export_photos_with_chrono_names, extract_video_frame_at,
    extract_video_frames, get_file_sizes, get_media_server_base, get_working_dir,
    has_photo_edit_undo, import_photos, list_photo_edit_marks, media_file_url,
    preview_frame_extract_times, rotate_photo, undo_photo_edit_for_path,
};
use commands::qr::{
...
use commands::video::{
    ...
    list_video_keyframes, probe_create_output_folder, probe_video, reset_upload_slot_cancel,
...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            create_video,
            create_job,
            start_speculative_create,
            speculative_create_status,
            cancel_speculative_create,
            ...
            export_photos_with_chrono_names,
            rotate_photo,
            crop_photo,
            ...
            get_handoff_status,
            delete_vorgaenge,
            set_vorgang_upload_state,
            probe_vorgang_folders,
            sync_open_handoffs,
            reconcile_stale_uploads,
            preflight_vorgang_upload,
            resync_vorgang_delivery_list,
